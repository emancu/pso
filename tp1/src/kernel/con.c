...
uint_8 getc(uint_16 scan_code) {
  switch (scan_code) {
    ...
    case 0x15: return 'y';
    case 0x2c: return 'z';
    case 0x39: return ' '; //Enter
    case 0x1c: return '\n'; //tab
    case 0x0f: return '\t'; //Backspace
    case 0x0e: return 0x08;
    case 0x38: altPressed = 1;          return 0;
    case 0x2a: shiftPressed = 1;        return 0;
    case 0x38 + 0x80: altPressed = 0;   return 0;
    case 0x2a + 0x80: shiftPressed = 0; return 0;
